      ...
      <CardContent className="user-repository ">
        ...
        <div className="card-footer-info">
          ...
          <span className="card-info-item">
            ...
            <Typography variant="body2" color="text.secondary">{repoData?.stargazers_count}</Typography>
          </span>
          <span className="card-info-item">
            ...
            <Typography variant="body2" color="text.secondary">{repoData?.forks_count}</Typography>
          </span>
          <span className="card-info-item">
            <svg
              aria-hidden="true"
