    ...
    <Box className="user-profile">
      <Box className="user-profile-wrapper">
        <Card className="profile-image-card">
          <CardMedia
            ...
            height="140"
            image={userData?.avatar_url || 'https://avatars.githubusercontent.com/u/102299323'}
          />
        </Card>
      ...
      <Box className="profile-follow">
        <Box className="profile-follow-item">
          ...
          <span className="follow-count">{userData?.followers || 0}</span>
          followers
        </Box>
        ·
        <Box className="profile-follow-item">
          <span className="follow-count">{userData?.following || 0}</span>
          following
        </Box>
      </Box>
      {userData?.company && (
        <Box className="profie-organization">
          ...
          <Typography className="profie-organization-name profile-detail">
            {userData?.company}
          </Typography>
        </Box>
      )}
      ...
      {userData?.html_url && (<Box className="profie-organization" sx={{ marginTop: "10px" }}>
        <svg
          aria-hidden="true"
          height="16"
          viewBox="0 0 16 16"
      ...
      {userData?.twitter_username && (<Box className="profie-organization" sx={{ marginTop: "10px" }}>
        <svg
