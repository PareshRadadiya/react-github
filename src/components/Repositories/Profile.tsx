    ...
    <Box className="user-profile">
      ...
      <Box className="profile-follow">
        <Box className="profile-follow-item">
          ...
          <span className="follow-count">393</span>
          followers
          </Box>
          · 
          <Box className="profile-follow-item">
            <span className="follow-count">71</span>
            following
          </Box>      
      </Box>
      ...
      <Box className="profie-organization" sx={{ marginTop: "10px" }}>
        ...
        <Typography className="profile-link profile-detail" sx={{ marginLeft: "7px" }}>
        Montreal, Canada {user?.location}
        </Typography>
      </Box>
      <Box className="profie-organization" sx={{ marginTop: "10px" }}>
